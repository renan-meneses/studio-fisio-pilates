...
namespace Clinica.Persistence.Migrations
{
    ...
    [Migration("20260822001742_AddRecuperacaoSenha")]
    partial class AddRecuperacaoSenha
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.Cobranca", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ProvedorCobrancaId")
                        .IsRequired()
                        .HasMaxLength(120)
                    ...
                    b.HasIndex("ClinicaId", "MensalidadeId")
                        .HasDatabaseName("IX_cobrancas_tenant_mensalidade");

                    b.HasIndex("Provedor", "ProvedorCobrancaId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.EventoPagamentoWebhook", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ClinicaId", "Provedor", "EventoId")
                        .IsUnique()
                        .HasDatabaseName("IX_webhook_tenant_provedor_evento");

                    b.ToTable("eventos_pagamento_webhook", (string)null);
                });
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.TokenRedefinicaoSenha", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("tokens_redefinicao_senha", (string)null);
                });
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.WaitlistEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ClinicaId", "TurmaId")
                        .HasDatabaseName("IX_waitlist_tenant_turma");

                    b.HasIndex("ClinicaId", "TurmaId", "PacienteId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Clinica.Domain.Entities.WaitlistEntry", b =>
                {
                    ...
                    b.HasOne("Clinica.Domain.Entities.Turma", null)
                        .WithMany()
                        .HasForeignKey("TurmaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
